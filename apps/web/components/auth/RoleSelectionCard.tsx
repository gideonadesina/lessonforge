...
export default function RoleSelectionCard({
  ...
  return (
    <button
      ...
      onClick={onClick}
      disabled={busy}
      className="group flex h-full w-full flex-col rounded-[1.5rem] border border-violet-100 bg-white p-6 text-left shadow-[0_22px_50px_-38px_rgba(15,23,42,0.75)] transition-all duration-300 hover:-translate-y-1 hover:border-violet-300 hover:shadow-[0_34px_70px_-42px_rgba(76,29,149,0.48)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-500/70 disabled:cursor-not-allowed disabled:opacity-70"
    >
      ...
      <div className="mt-6 text-sm font-semibold text-violet-700">
