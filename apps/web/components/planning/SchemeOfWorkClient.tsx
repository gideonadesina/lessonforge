        ...
        <div className="mt-4 grid gap-3 md:grid-cols-4">
          <label className="text-xs text-slate-600">
            ...
            <input
              ...
              onChange={(e) =>
                setDraftFilters((prev: SchemeOfWorkFilters) => ({ ...prev, class_name: e.target.value }))
              }
          ...
          <label className="text-xs text-slate-600">
            ...
            <input
              ...
              onChange={(e) =>
                setDraftFilters((prev: SchemeOfWorkFilters) => ({ ...prev, subject: e.target.value }))
              }
          ...
          <label className="text-xs text-slate-600">
            ...
            <input
              ...
              onChange={(e) =>
                setDraftFilters((prev: SchemeOfWorkFilters) => ({ ...prev, term: e.target.value }))
              }
        ...
        <div className="mt-4 grid gap-3 md:grid-cols-2 lg:grid-cols-3">
          ...
          <label className="text-xs text-slate-600">
            ...
            <select
              ...
              className="mt-1 w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm text-slate-900 outline-none focus:border-violet-400"
            >
              {SCHEME_STATUS_OPTIONS.map((option: { value: SchemeStatus; label: string }) => (
