...
export default function LessonSlidesPage() {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-b from-[#FAFAF8] to-[#F5F4F1] px-6 py-10">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <Field label="Topic" full>
                <input
                  ...
                  required
                  className="w-full rounded-xl border border-slate-200 bg-white px-3 py-2.5 text-sm outline-none focus:border-purple-400 focus:ring-2 focus:ring-purple-100"
                />
              </Field>
